...
class DocumentOutlineGenerator:
	...
	def __init__(
		...
		self.logger.info(f"DocumentOutlineGenerator initialized with model: {ollama_model}")
	...
	def _initialize_psychology_biases(self):
		...
		self.psychology_biases = {
			PsychologyBias.ANCHORING: {
				...
				'examples': ['Premium pricing models', 'Implementation timelines', 'ROI projections']
			},
			PsychologyBias.SOCIAL_PROOF: {
				...
				'examples': ['Client success stories', 'Market leader endorsements', 'Industry statistics']
			},
			PsychologyBias.AUTHORITY: {
				...
				'examples': ['Expert team bios', 'Industry certifications', 'Award recognition']
			},
			PsychologyBias.RECIPROCITY: {
				...
				'examples': ['Free assessment', 'Industry insights', 'Best practices guide']
			},
			PsychologyBias.SCARCITY: {
				...
				'examples': ['Exclusive partnership', 'Limited engagement slots', 'Market timing']
			},
			PsychologyBias.LOSS_AVERSION: {
				...
				'examples': ['Competitive gaps', 'Market share erosion', 'Regulatory compliance risks']
			},
			PsychologyBias.EMOTIONAL_APPEAL: {
				...
				'examples': ['Innovation leadership', 'Team empowerment', 'Legacy building']
			},
			PsychologyBias.PROBLEM_AGITATION: {
				...
				'examples': ['Cost of inaction', 'Efficiency gaps', 'Security vulnerabilities']
			}
		}
	...
	def _initialize_document_templates(self):
		...
		self.document_templates = {
			DocumentType.BUSINESS_PROPOSAL: {
				'structure': [
					{'title': 'Executive Summary', 'level': 1, 'word_count': 400, 'biases': [PsychologyBias.ANCHORING, PsychologyBias.EMOTIONAL_APPEAL]},
					{'title': 'Understanding Your Needs', 'level': 1, 'word_count': 300, 'biases': [PsychologyBias.PROBLEM_AGITATION, PsychologyBias.AUTHORITY]},
					{'title': 'Proposed Solution', 'level': 1, 'word_count': 600, 'biases': [PsychologyBias.SOCIAL_PROOF, PsychologyBias.RECIPROCITY]},
					{'title': 'Why Choose Us', 'level': 1, 'word_count': 400, 'biases': [PsychologyBias.AUTHORITY, PsychologyBias.SOCIAL_PROOF]},
					{'title': 'Investment & ROI', 'level': 1, 'word_count': 350, 'biases': [PsychologyBias.ANCHORING, PsychologyBias.LOSS_AVERSION]},
					{'title': 'Implementation Timeline', 'level': 1, 'word_count': 250, 'biases': [PsychologyBias.SCARCITY, PsychologyBias.RECIPROCITY]},
					{'title': 'Next Steps', 'level': 1, 'word_count': 200, 'biases': [PsychologyBias.SCARCITY, PsychologyBias.EMOTIONAL_APPEAL]}
				],
				'total_word_count': 2500,
				'primary_biases': [PsychologyBias.ANCHORING, PsychologyBias.SOCIAL_PROOF, PsychologyBias.AUTHORITY]
			},
			
			DocumentType.TECHNICAL_PROPOSAL: {
				'structure': [
					{'title': 'Executive Summary', 'level': 1, 'word_count': 300, 'biases': [PsychologyBias.AUTHORITY, PsychologyBias.ANCHORING]},
					{'title': 'Technical Requirements Analysis', 'level': 1, 'word_count': 500, 'biases': [PsychologyBias.AUTHORITY, PsychologyBias.PROBLEM_AGITATION]},
					{'title': 'Proposed Technical Solution', 'level': 1, 'word_count': 800, 'biases': [PsychologyBias.SOCIAL_PROOF, PsychologyBias.AUTHORITY]},
					{'title': 'Architecture & Design', 'level': 1, 'word_count': 600, 'biases': [PsychologyBias.AUTHORITY]},
					{'title': 'Implementation Methodology', 'level': 1, 'word_count': 450, 'biases': [PsychologyBias.RECIPROCITY, PsychologyBias.SOCIAL_PROOF]},
					{'title': 'Quality Assurance & Testing', 'level': 1, 'word_count': 300, 'biases': [PsychologyBias.LOSS_AVERSION]},
					{'title': 'Team & Expertise', 'level': 1, 'word_count': 350, 'biases': [PsychologyBias.AUTHORITY, PsychologyBias.SOCIAL_PROOF]},
					{'title': 'Timeline & Deliverables', 'level': 1, 'word_count': 300, 'biases': [PsychologyBias.SCARCITY, PsychologyBias.ANCHORING]}
				],
				'total_word_count': 3600,
				'primary_biases': [PsychologyBias.AUTHORITY, PsychologyBias.SOCIAL_PROOF, PsychologyBias.LOSS_AVERSION]
			},
			
			DocumentType.RFP_RESPONSE: {
				'structure': [
					{'title': 'Executive Summary', 'level': 1, 'word_count': 400, 'biases': [PsychologyBias.ANCHORING, PsychologyBias.AUTHORITY]},
					{'title': 'RFP Requirements Matrix', 'level': 1, 'word_count': 200, 'biases': [PsychologyBias.AUTHORITY]},
					{'title': 'Technical Response', 'level': 1, 'word_count': 1000, 'biases': [PsychologyBias.AUTHORITY, PsychologyBias.SOCIAL_PROOF]},
					{'title': 'Management Approach', 'level': 1, 'word_count': 600, 'biases': [PsychologyBias.RECIPROCITY, PsychologyBias.SOCIAL_PROOF]},
					{'title': 'Corporate Experience', 'level': 1, 'word_count': 500, 'biases': [PsychologyBias.SOCIAL_PROOF, PsychologyBias.AUTHORITY]},
					{'title': 'Pricing', 'level': 1, 'word_count': 300, 'biases': [PsychologyBias.ANCHORING, PsychologyBias.LOSS_AVERSION]},
					{'title': 'Value Added Services', 'level': 1, 'word_count': 300, 'biases': [PsychologyBias.RECIPROCITY, PsychologyBias.SOCIAL_PROOF]},
					{'title': 'Conclusion', 'level': 1, 'word_count': 200, 'biases': [PsychologyBias.EMOTIONAL_APPEAL, PsychologyBias.SCARCITY]}
				],
				'total_word_count': 3500,
				'primary_biases': [PsychologyBias.AUTHORITY, PsychologyBias.SOCIAL_PROOF, PsychologyBias.ANCHORING]
			}
		}
	...
	async def generate_complete_outline(
		...
		try:
			...
			result.initial_outline = await self._generate_initial_outline(document_type, context, target_word_count)
			...
			result.suggested_improvements = await self._identify_outline_improvements(result.initial_outline, context)
			result.model_calls += 1
			...
			self.logger.info(f"Multi-stage outline generation completed in {result.generation_time:.2f}s")
	...
	async def _generate_initial_outline(
		...
		if not template:
			self.logger.warning(f"No template found for {document_type}, using business proposal template")
...
Please generate the complete outline now:"""
			...
			async with aiohttp.ClientSession(timeout=timeout) as session:
				async with session.post(
					...
					if response.status == 200:
						...
						outline = await self._parse_outline_json(generated_text, document_type)
						return outline
					else:
	...
	async def _parse_outline_json(self, response_text: str, document_type: DocumentType) -> Optional[DocumentOutline]:
		...
		try:
			...
			outline = DocumentOutline(
				...
				total_word_count_target=outline_data.get('total_word_count_target', 2000)
			)
	...
	def _parse_outline_elements(self, elements_data: List[Dict]) -> List[OutlineElement]:
	...
	def _build_context_string(self, context: Dict[str, Any]) -> str:
		...
		if context.get('key_requirements'):
			context_parts.append(f"Key Requirements: {', '.join(context['key_requirements'])}")
...
Generate the 10 improvements now:"""
			...
			async with aiohttp.ClientSession(timeout=timeout) as session:
				async with session.post(
					...
					if response.status == 200:
						...
						improvements = await self._parse_improvements_json(generated_text)
	...
	def _outline_to_summary(self, outline: DocumentOutline) -> str:
		...
		summary_parts.append(f"Total Word Count Target: {outline.total_word_count_target}")
	...
	def _add_element_to_summary(self, element: OutlineElement, summary_parts: List[str], indent: int):
		"""Recursively add element to summary"""
		indent_str = "  " * indent
		summary_parts.append(f"{indent_str}- {element.title} ({element.word_count_target} words)")
	...
	async def _parse_improvements_json(self, response_text: str) -> List[OutlineImprovement]:
		...
		try:
			...
			for imp_data in improvements_data:
				...
				improvement = OutlineImprovement(
					...
					implementation_difficulty=imp_data.get('implementation_difficulty', 'medium')
				)
	...
	async def _apply_outline_improvements(
		...
		sorted_improvements = sorted(improvements, key=lambda x: x.impact_score, reverse=True)
		
		# Apply each improvement
		for improvement in sorted_improvements:
			try:
				await self._apply_single_improvement(enhanced_outline, improvement, context)
			except Exception as e:
				self.logger.warning(f"Failed to apply improvement {improvement.id}: {e}")
		
		return enhanced_outline
	
	def _deep_copy_elements(self, elements: List[OutlineElement]) -> List[OutlineElement]:
	...
	async def _add_new_section(self, outline: DocumentOutline, improvement: OutlineImprovement, context: Dict[str, Any]):
		"""Add a new section based on improvement suggestion"""
		
		# Create new outline element
		new_element = OutlineElement(
			type="section",
			title=improvement.description.split(':')[0].strip() if ':' in improvement.description else improvement.description,
		...
		if improvement.element_id:
			...
			parent_element = self._find_element_by_id(outline.elements, improvement.element_id)
			if parent_element:
	...
	async def _enhance_existing_section(self, outline: DocumentOutline, improvement: OutlineImprovement):
		...
		if element:
			...
			if bias_guidance:
				element.content_guidance += f" Integrate {', '.join(bias_guidance)} principles."
			
			# Increase priority if high impact
			if improvement.impact_score > 0.7:
				element.priority = "high"
	
	async def _restructure_sections(self, outline: DocumentOutline, improvement: OutlineImprovement):
		...
		element = self._find_element_by_id(outline.elements, improvement.element_id)
		if element:
			element.content_guidance += f" RESTRUCTURING NOTE: {improvement.description}"
			element.rationale += f" Restructuring rationale: {improvement.justification}"
	
	async def _remove_section(self, outline: DocumentOutline, improvement: OutlineImprovement):
		"""Remove or consolidate a section"""
		# Mark section for consolidation rather than actual removal
		element = self._find_element_by_id(outline.elements, improvement.element_id)
		if element:
			element.content_guidance += f" CONSOLIDATION NOTE: {improvement.description}"
			element.priority = "low"  # Mark as lower priority
	
	def _find_element_by_id(self, elements: List[OutlineElement], element_id: str) -> Optional[OutlineElement]:
	...
	def _estimate_word_count_for_new_section(self, improvement: OutlineImprovement) -> int:
	...
	async def _enhance_with_psychology(self, outline: DocumentOutline, context: Dict[str, Any]):
		...
		outline.persuasion_strategy = self._determine_persuasion_strategy(outline.document_type, context)
	...
	def _determine_persuasion_strategy(self, document_type: DocumentType, context: Dict[str, Any]) -> str:
		...
		if document_type == DocumentType.TECHNICAL_PROPOSAL:
			...
			return "Compliance-first with competitive differentiation and risk mitigation"
		else:
			return "Balanced approach with authority, social proof, and value demonstration"
	
	async def _enhance_element_with_psychology(self, element: OutlineElement, primary_biases: List[PsychologyBias]):
		...
		if element.title.lower() in ['executive summary', 'introduction']:
			element.psychology_biases.extend([PsychologyBias.ANCHORING, PsychologyBias.EMOTIONAL_APPEAL])
		
		elif 'team' in element.title.lower() or 'experience' in element.title.lower():
			element.psychology_biases.extend([PsychologyBias.AUTHORITY, PsychologyBias.SOCIAL_PROOF])
		
		elif 'cost' in element.title.lower() or 'investment' in element.title.lower() or 'roi' in element.title.lower():
			element.psychology_biases.extend([PsychologyBias.ANCHORING, PsychologyBias.LOSS_AVERSION])
		
		elif 'timeline' in element.title.lower() or 'next steps' in element.title.lower():
			element.psychology_biases.extend([PsychologyBias.SCARCITY, PsychologyBias.RECIPROCITY])
		
		elif 'solution' in element.title.lower() or 'approach' in element.title.lower():
			element.psychology_biases.extend([PsychologyBias.SOCIAL_PROOF, PsychologyBias.AUTHORITY])
		...
		if element.psychology_biases:
			...
			element.content_guidance += f" Leverage {', '.join(bias_names)} psychology principles."
	...
	async def _assess_outline_quality(self, result: OutlineGenerationResult):
		...
		result.outline_quality = (result.structural_coherence + result.psychology_integration) / 2
	...
	def _assess_psychology_integration(self, outline: DocumentOutline) -> float:
		...
		elements_with_psychology = self._count_elements_with_psychology(outline.elements)
...
# Factory function
def create_document_outline_generator(config: Optional[Dict[str, Any]] = None) -> DocumentOutlineGenerator:
