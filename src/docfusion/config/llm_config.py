...
class LLMConfigManager:
	...
	def _create_task_config(
		...
		config.model = env_config.get("default_model", task_config.get("model", config.model))
		config.timeout = env_config.get("default_timeout", task_config.get("timeout", config.timeout))
		config.num_predict = env_config.get("default_num_predict", task_config.get("num_predict", config.num_predict))
		...
		# Apply feature flags
		config.enable_thinking_filter = features.get("enable_thinking_tag_filtering", True)
	...
	def _apply_profile(self, config: LLMConfiguration, profile: ModelProfile) -> LLMConfiguration:
