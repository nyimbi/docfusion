...
class DocumentCreateRequest(BaseModel):
	...
	encrypt_content: Optional[bool] = Field(
		None,
		description="Whether to encrypt document content"
	)
	
	sharing_permissions: Optional[Dict[str, str]] = Field(
		None,
		description="Initial sharing permissions (user_id: permission_level)"
	)
...
class DocumentResponse(BaseModel):
	...
	permission_level: str = Field(..., description="User's permission level for this document")
...
class DocumentHistoryResponse(BaseModel):
	...
	history: List[DocumentHistoryEntry] = Field(..., description="Version history entries")
...
class EnhancedSearchResult(BaseModel):
	...
	chunk_id: Optional[str] = Field(None, description="Chunk identifier for RAG results")
...
class BulkOperationResult(BaseModel):
	...
	total_requested: int = Field(..., description="Total documents requested for operation")
	...
	processed_ids: List[str] = Field(
		default_factory=list,
		description="Successfully processed document IDs"
	)
...
class DocumentAnalytics(BaseModel):
	...
	category_distribution: Dict[str, int] = Field(
		...
		description="Distribution of documents by category"
	)
	...
	activity_timeline: List[Dict[str, Union[str, int]]] = Field(
		default_factory=list,
		description="Document creation activity over time"
	)
	
	user_activity: Optional[Dict[str, Any]] = Field(
		None,
		description="User-specific activity metrics"
	)
