...
| F-018C | Pricing and price approval | J6 | local-production | P0 | local-mutating | e2e + integration | Pricing package, BOE, authority approval, lock, and reopen proof | `e2e_20260503_docfusion_pricing` | product-lane | blocked | `code:pricing-approval-workflow`, `vitest:pricing-approval-workflow` | cleanup-pending |
...
| F-020 | Render/export/download artifact | J8 | local-production | P0 | local-mutating | e2e + observability | Rendered file/hash/download metadata | `e2e_20260503_docfusion_render` | product-lane | blocked | `code:final-artifact-workflow`, `vitest:final-artifact-workflow` | cleanup-pending |
...
| 2026-05-05T18:48Z | Wave 6 pricing approval proof added workflow-backed cost element submit/approve/reject/reopen, pricing package review request/lock/reject/reopen runtime projection, BOE gates, all-costs-approved lock gates, critical cost-technical issue blocking with authority waiver, approval metadata, and workflow runtime task/audit coverage. F-018C remains blocked until authenticated pricing UI, live runtime, and cleanup evidence are captured. | F-018C |
| 2026-05-05T19:24Z | Wave 6 final artifact proof added workflow-backed render request, approved/final render gate, SHA-256 artifact hash calculation, filename/MIME/size/download metadata persistence, final artifact approval, proposal-document finalization, reopen compensation, and workflow runtime task/audit coverage. F-020 remains blocked until authenticated browser download, live artifact readback, and cleanup evidence are captured. | F-020 |
