"""
DANIDA (Danish International Development Agency) Scraper
=========================================================

Scrapes procurement opportunities from DANIDA.

URL: https://www.danida.dk/en/

Notes:
- DANIDA is Denmark's development cooperation agency
- Procurement for consulting, goods, and works
- Focuses on poverty reduction and sustainable development
- Part of Danish Ministry of Foreign Affairs
...
class DANIDAScraper(BaseScraper):
	"""Scraper for DANIDA procurement opportunities."""

	source_id = "danida"
	source_name = "Danish International Development Agency"
	base_url = "https://www.danida.dk"
	...
	async def scrape(self) -> list[ScrapedOpportunity]:
		"""Scrape DANIDA procurement opportunities."""
		...
		for path in search_paths:
			try:
				self._log_info(f"Fetching DANIDA from {path}")
	...
	def _parse_item(self, item: Any) -> ScrapedOpportunity | None:
		"""Parse a single procurement item from DANIDA."""
