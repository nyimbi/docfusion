...
const NON_SOLICITATION_DOCUMENT_PATTERN = /(?:\binvestors?\b|\bsales[-_\s]?results\b|\bfinancial[-_\s]?results\b|\bquarterly[-_\s]?report(?:\b|[-_])|\bannual[-_\s]?(?:operational[-_\s]?procurement[-_\s]?)?report(?:\b|[-_])|\bq[1-4][-_]20\d{2}[-_\s]?report(?:\b|[-_])|\btechnical[-_\s]?report\b|(?:^|[^a-z0-9])impact[-_\s]?report(?:\b|[-_])|\bguide[-_\s]?to[-_\s]?doing[-_\s]?business\b|(?:^|[^a-z0-9])procurement[-_\s]?(?:plan|report)\b|(?:^|[^a-z0-9])(?:agpm|ppm)(?:[^a-z0-9]|$)|\bpublic[-_\s]?governance[-_\s]?reviews\b|\/publications\/reports\/|\bdirective[-_\s]?on[-_\s]?procurement\b|\binstructions[-_\s]?for[-_\s]?recipients\b|\bbidder[-_\s]?instructions\b|\bprocurement[-_\s]?policy\b|\bpolicies[-_\s]?strategies\b|\bsenior[-_\s]?procurement[-_\s]?executive[-_\s]?message\b|\blapse[-_\s]?in[-_\s]?appropriations\b|\bjustification[-_\s]?and[-_\s]?approval\b|\bother[-_\s]?than[-_\s]?full[-_\s]?and[-_\s]?open[-_\s]?competition\b|\btips\.pdf\b|\bconduct[-_\s]?english\.pdf\b|\b(?:supplier|vendor)[-_\s]?(?:code[-_\s]?of[-_\s]?)?conduct\b|(?:^|[^a-z0-9])(?:procurement|vendor|supplier)[-_\s]?(?:guide|manual|handbook)(?:\b|[-_\s])|\bglobal[-_\s]?marketplace[-_\s]?guide\b|\bgbg[-_\s]?master\b|\bun\.org\/.*\/pm\.pdf\b|\bguide[-_\s]?\d*[-_\s]?submit[-_\s]?quotations[-_\s]?bids[-_\s]?proposals\b|\bentities[-_\s]*[-_\s]?20\d{2}[-_\s]?quarter\b|\bnpm[-_.\s]?no\.?[-_.\s]?\d+(?:[-_.\s]?\d+)?\b|corrigendum|\bannex(?:ure)?[-_\s]?[cde]\b|\blocal[-_\s]?(?:and[-_\s]?)?imported[-_\s]?content[-_\s]?declaration\b|\bmodeles?[-_\s]?d[-_\s]?avis\b|\bavis[-_\s]?d[-_\s]?attribution\b|\battribution[-_\s]?(?:provisoire|definitive|définitive)\b|\b(?:resultat|resultats|résultat|résultats)(?:\b|[-_.\s])|\b(?:pv|proces[-_\s]?verbal)[-_.\s]?(?:(?:de|d)[-_.\s]?)?(?:resultat|resultats|résultat|résultats|attri\.?|attribution|ouverture[-_.\s]des[-_.\s]offres)(?:\b|[-_.\s])|\bpublication[-_\s]des[-_\s]resultats[-_\s]d[-_\s]?evaluation\b|\bavis[-_\s]?d[-_\s]?annulation\b|\bannulation[-_\s]?de[-_\s]?la[-_\s]?dp\b|\b(?:regret|unsuccessful[-_\s]suppliers?)\b|\b(?:award|awards?|awarded)[-_\s]?notice\b|\bcontract[-_\s]?awards?\b|\btender[-_\s]?cancell?ation\b|\b(?:approved[-_\s]?20\d{2}[-_\s]?pp|pp20\d{2})[-_\s]?(?:works|goods|consultants|resource|services)\b|\bjob[-_\s]?application[-_\s]?form\b|\bjob[-_\s]?profile\b|\bjob[-_\s]?description\b|\bprofil[-_\s]?du[-_\s]?poste\b|\bperfil[-_\s]?do[-_\s]?cargo\b)/i;
