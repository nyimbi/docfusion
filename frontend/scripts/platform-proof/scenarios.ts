...
export const PLATFORM_PROOF_SCENARIOS: ProofScenarioDefinition[] = [
	...
	},
	{
		...
		requiresLiveServices: false,
		description: "Validates AI governance, LiteLLM provider behavior, deterministic quality assessment, content governance workflows, snippet provenance, and placeholder resolution.",
		command: {
			command: "npm",
			args: ["test", "--", "ai-governance.test.ts", "quality-assessment.test.ts", "content-governance-workflow.test.ts", "snippet-expansion-provenance.test.ts", "snippet-placeholder-resolution.test.ts", "litellm-provider.test.ts"],
		},
		expectedArtifacts: ["vitest:ai-governance", "vitest:quality-assessment", "vitest:content-governance-workflow", "vitest:snippet-expansion-provenance", "vitest:snippet-placeholder-resolution", "vitest:litellm-provider"],
	},
	{
