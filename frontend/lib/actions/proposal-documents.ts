...
function artifactSummary(value: unknown): ProposalDocument["finalArtifact"] {
	...
	return {
		...
		storageReadbackHash: typeof record.storageReadbackHash === "string" ? record.storageReadbackHash : null,
		storageReadbackSize: typeof record.storageReadbackSize === "number" ? record.storageReadbackSize : null,
		storageReadbackAt: typeof record.storageReadbackAt === "string" || record.storageReadbackAt instanceof Date ? record.storageReadbackAt : null,
