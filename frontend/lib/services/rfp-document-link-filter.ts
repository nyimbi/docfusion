export const LOW_VALUE_PROCUREMENT_DOCUMENT_LINK_REGEX_SOURCE = String.raw`(?:\bannual[-_\s]?report\b|\bcontract[-_\s]?awards?\b|\bcontractawards?(?:above)?|\bawards?(?:[-_\s]?above|above)|\baward[-_\s]?notice\b|\bnotice[-_\s]?of[-_\s]?awards?\b|\bprocurement[-_\s]?plan\b|\bvendor[-_\s]?profile\b|(?:^|[^a-z0-9])supplier[-_\s]?(?:code|conduct|guide|manual)(?:\b|[-_\s])|(?:^|[^a-z0-9])(?:procurement|vendor|supplier)[-_\s]?(?:guide|manual|handbook)(?:\b|[-_\s])|\bglobal[-_\s]?marketplace[-_\s]?guide\b|\bgbg[-_\s]?master\b|\bcode[-_\s]?of[-_\s]?conduct\b|\bfinancial[-_\s]?(?:statement|report)\b|\baudit[-_\s]?report\b|\bnewsletter\b|\bpress[-_\s]?releases?\b|\bprivacy[-_\s]?notice\b|\bterms[-_\s]?of[-_\s]?use\b|\bcover[-_\s]?page\b|\bregret[-_\s]?letter\b|\bcancell?ation[-_\s]?letter\b|\btender[-_\s]?cancell?ation\b|\bquality[-_\s]?control[-_\s]?plan\b|\binspection[-_\s]?test[-_\s]?plan\b|\bqcp\b|\bitp\b)`;
