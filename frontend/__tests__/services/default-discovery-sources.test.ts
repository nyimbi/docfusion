...
describe("default discovery sources", () => {
	it("preloads broad RFP queries plus live-proven and browser-fallback-capable procurement sources", () => {
		expect(DEFAULT_DISCOVERY_QUERIES).toEqual([
			...
			"site:marchespublics.ci appel d'offres date limite",
			"site:armp.cm appel d'offres date limite",
			"site:marchespublics.gov.ma appel d'offres date limite",
			"site:armp.sn appel d'offres date limite",
