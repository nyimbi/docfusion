...
- Investigate `search.lindela.io` SearXNG engine degradation and public fallback rate limits; the live run repeatedly reported Google access denied, Brave/DuckDuckGo throttling/timeouts, Startpage CAPTCHA, and public fallback 403/429 responses.
