...
<!-- SECTION:NOTES:BEGIN -->
Added African procurement sources registry with 58 ISO-2 codes, 7 regional portals, 28 national portals, and fallbacks for all remaining countries. Wired into GlobalSourceDB. 4 tests passing.
<!-- SECTION:NOTES:END -->
