...
<!-- SECTION:NOTES:BEGIN -->
Added __init__.py to 6 collaboration subdirs: integration, docs, conflicts, editing, versioning, conflict_resolution. 1 test passing.
<!-- SECTION:NOTES:END -->
